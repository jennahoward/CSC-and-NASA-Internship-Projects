...
public:
    ...
    int retrieveAt(int location) const;
      ...
      //Postcondition: retItem = list[location] is returned
      //               If location is out of range, an 
      //               appropriate message is displayed.
    ...
    virtual void removeAll(int removeItem) = 0;
      //This function removes all instances of removeItem from the
      //list. 
      //Postcondition: Any instances of removeItem in the list are
